...
public class JwtUserJudicialAuthenticationTokenFilter extends UsernamePasswordAuthenticationFilter {
	private AuthenticationManager authenticationManager;

	public JwtUserJudicialAuthenticationTokenFilter(AuthenticationManager authenticationManager) {

		
		this.authenticationManager = authenticationManager;
		super.setFilterProcessesUrl("/app/judicial/auth/login");
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
			...
			String password =null;
			 if(request != null && request.getContentType() != null && request.getContentType().indexOf(MediaType.APPLICATION_JSON_VALUE)!=-1)
			 {
