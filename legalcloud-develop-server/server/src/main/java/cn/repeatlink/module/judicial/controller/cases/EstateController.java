...
@ApiSort(4)
public class EstateController extends BaseJudicialController {
	...
	@GetMapping(value = "/{estate_id}/pdf/download", produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
...
//	}
	...
	@ApiOperation(value="获取不动产地址区域信息",notes = "获取不动产地址区域")
